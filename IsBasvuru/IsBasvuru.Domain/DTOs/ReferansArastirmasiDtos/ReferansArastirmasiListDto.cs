...
{
    public class ReferansArastirmasiListDto
    {
        ...
        // 🎯 EKLENDİ: React'ta listelerken "Görüşmeyi Yapan: Ahmet Yılmaz" yazabilmek için:
        public string? GorusmeyiYapanKullaniciAdSoyad { get; set; }
